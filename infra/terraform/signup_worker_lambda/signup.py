# VENDORED COPY of app/signup.py (HA-7). Keep in sync with the app module.
# The bird pattern copies common/ into each lambda zip; this mirrors that so
# `terraform validate`/`plan` and the zip build need no build tooling.
